...
import { Plus, Download, MoreVertical, Calendar, Eye, Pencil, Trash2 } from "lucide-react"
                ...
                <tr key={article.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="max-w-sm">
                      <div 
                        className="font-semibold text-slate-900 cursor-pointer hover:text-blue-600 transition-colors mb-1"
